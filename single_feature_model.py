...
class Model():
    ...
    The model takes in a state and outputs a prediction (0 = Hold, 1 = Buy, 2 = Sell) in the action_space.
    This model uses:
        - a replay memory to train itself on past transactions. 
        - an epsilon-greedy policy to explore the environment randomly during training.
        - a discount factor (gamma) to maximize reward over the long-term.
    This version of the model trains only on the closing price of the stock.
    '''
